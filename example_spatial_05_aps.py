...
ICASAR_settings = {"n_comp": 5,  # number of components to recover with ICA (ie the number of PCA sources to keep)
                   ...
                   "out_folder": Path('example_spatial_05_APS_all'),  # outputs will be saved here
...
deformation_velocity_ica=stacking_insar(S_ica,A_ica,1,mask,file_path,time_baselines_cum,phUnw_mean,fig_title=fig_title_01)
