		#example_spatial_04_outputs_sICA_A_all 代表升轨数据+‘all’形式干涉图组织
#读取数据
import pickle
import matplotlib.pyplot as plt
import numpy as np

filepath_displacement='/home/z/data/licsbas_example02/026A_05924/results/displacement_r2.pkl'
filepath_tbaselines='/home/z/data/licsbas_example02/026A_05924/results/tbaseline_info.pkl'
...
from icasar_main import ICASAR
...
ICASAR_settings = {"n_comp": 5,  # number of components to recover with ICA (ie the number of PCA sources to keep)
                   ...
                   "out_folder": Path('example_spatial_04_outputs_tICA_A'),  # outputs will be saved here
...
#print('\nsources_labels:\n',sources_labels)
                                              ...
                                              #%%% 结果判读部分
from icasar_aux import visualise_ICASAR_inversion
from icasar_aux3 import recover_signal_timeseries_plot,plot_mixtures_ifgs,stacking_insar
