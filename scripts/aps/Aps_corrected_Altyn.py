...
# Date: 2024/01/19
# Function:
#   use the Aps corrected data to the Altyn fault   
#-------------------------------------------------------------------
import datetime
import numpy as np
...
file_path_corrected='data/Altyn_Tagh_Fault/aps_data/CorrectedIfgs-model6-defoFlag1-wetFlag1-hydroFlag2-iteraNum1-solver2-ueFixMethod0-weightScheme1-shortBt60-shortBtRelax500'
...
for unw_name in unw_names:
    fullpath=os.path.join(file_path_corrected,unw_name)
...
print('\ndisplacement\n',displacement_r3['incremental'].shape)
